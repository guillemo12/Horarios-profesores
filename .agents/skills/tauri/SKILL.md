---
name: tauri
description: Cross-platform desktop application framework combining Rust backend with web frontend, emphasizing security, performance, capability permissions, and multi-window lifecycle.
---
