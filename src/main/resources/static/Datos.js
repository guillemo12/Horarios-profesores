(()=>{var Le=Object.defineProperty;var He=(t,e,r)=>e in t?Le(t,e,{enumerable:!0,configurable:!0,writable:!0,value:r}):t[e]=r;var T=(t,e,r)=>He(t,typeof e!="symbol"?e+"":e,r);var N=class{constructor(){T(this,"baseUrl");this.baseUrl="/api/v1"}async _fetch(e,r="GET",o=null){let n=`${this.baseUrl}/${e}`,a={method:r,headers:{"Content-Type":"application/json"}};o&&(a.body=JSON.stringify(o));let d=await fetch(n,a);if(!d.ok)throw new Error(`HTTP error! status: ${d.status}`);return r==="DELETE"?{success:!0}:await d.json()}async getConfig(){return this._fetch("config")}async saveConfig(e){return this._fetch("config","PUT",e)}async getSubjects(){return this._fetch("subjects")}async saveSubject(e){return e.id?this._fetch("subjects","PUT",e):this._fetch("subjects","POST",e)}async deleteSubject(e){return this._fetch(`subjects/${e}`,"DELETE")}async getTeachers(){return this._fetch("teachers")}async saveTeacher(e){return e.id?this._fetch("teachers","PUT",e):this._fetch("teachers","POST",e)}async deleteTeacher(e){return this._fetch(`teachers/${e}`,"DELETE")}async getCourses(){return this._fetch("courses")}async saveCourse(e){return e.id?this._fetch("courses","PUT",e):this._fetch("courses","POST",e)}async deleteCourse(e){return this._fetch(`courses/${e}`,"DELETE")}async updateCourseGroup(e,r){return this._fetch(`courses/${e}/groups`,"PUT",r)}async getSchedule(){return this._fetch("scheduledClasses")}async saveClass(e){return this._fetch("scheduledClasses","POST",e)}async updateClass(e){return this._fetch("scheduledClasses","PUT",e)}async deleteClass(e){return this._fetch(`scheduledClasses/${e}`,"DELETE")}async deleteGroupSchedule(e){return this._fetch(`scheduledClasses/group/${e}`,"DELETE")}async getPrevalidation(){return this._fetch("prevalidation")}};function u(t,e,r="info"){let o=document.getElementById("toast-container");if(!o)return;let n=document.createElement("div"),a=r==="error"?"border-red-500 text-red-500":r==="success"?"border-green-500 text-green-500":r==="warning"?"border-yellow-500 text-yellow-500":"border-blue-500 text-blue-500";n.className=`bg-white border-l-4 ${a} shadow-lg rounded-r-lg p-4 w-80 transform transition-all duration-300 translate-y-4 opacity-0 flex gap-3`,n.innerHTML=`<div><h4 class="text-sm font-bold text-gray-800">${t}</h4><p class="text-xs text-gray-600 mt-1">${e}</p></div>`,o.appendChild(n),setTimeout(()=>n.classList.remove("translate-y-4","opacity-0"),10),setTimeout(()=>{n.classList.add("opacity-0","translate-x-full"),setTimeout(()=>n.remove(),300)},4e3)}function M(t){return Number(t.toFixed(2)).toString()}var R=class{constructor(){T(this,"isConnected");T(this,"isOptimizing");T(this,"wsUrl");T(this,"callbacks");T(this,"socket");this.wsUrl=(window.location.protocol==="https:"?"wss://":"ws://")+window.location.host+"/ws",this.isConnected=!1,this.isOptimizing=!1,this.callbacks={},this.socket=null}connect(){this.socket=new WebSocket(this.wsUrl),this.socket.onopen=()=>{this.isConnected=!0,this._trigger("connected")},this.socket.onclose=()=>{this.isConnected=!1,this._trigger("disconnected"),setTimeout(()=>this.connect(),5e3)},this.socket.onerror=e=>{console.error("WebSocket error:",e)},this.socket.onmessage=e=>{try{let r=JSON.parse(e.data);r.type==="scores_updated"?this._trigger("scores_updated",r):r.type==="schedule_pushed"?this._trigger("schedule_pushed",r.schedule):r.type==="optimization_complete"?this._trigger("optimization_complete"):r.type==="optimization_stopped"&&(this.isOptimizing=!1)}catch(r){console.error("Error parsing WS message:",r)}}}on(e,r){this.callbacks[e]=r}_trigger(e,r){this.callbacks[e]&&this.callbacks[e](r)}sendCommand(e,r={}){try{if(!this.isConnected||!this.socket){u("Error","WebSocket Desconectado","error");return}this.socket.send(JSON.stringify({command:e,payload:r})),e==="START"?(this.isOptimizing=!0,u("Motor Iniciado","Servidor analizando el \xE1rbol de posibilidades (WS)...","info")):e==="STOP"&&(this.isOptimizing=!1,u("Motor Pausado","Optimizaci\xF3n detenida.","warning"))}catch(o){throw console.error("Error sending WS command:",o),u("Error de Comunicaci\xF3n","No se pudo enviar el comando al servidor","error"),o}}};function G(){if(!s.calendarInstance)return;let t=s.calendarInstance.getDateRangeStart(),e=s.calendarInstance.getDateRangeEnd(),r=n=>{let a=typeof n.toDate=="function"?n.toDate():new Date(n),d=["Ene","Feb","Mar","Abr","May","Jun","Jul","Ago","Sep","Oct","Nov","Dic"];return`${a.getDate()} ${d[a.getMonth()]}`},o=document.getElementById("calendar-date-range");o&&(o.textContent=`${r(t)} - ${r(e)}`)}function U(t=null){let e=document.getElementById("header-course-select"),r=document.getElementById("view-entity-select");if(!e||!r)return;let o=e.value;r.innerHTML="";let n=s.courses.find(a=>a.id===o);n&&(n.groups.length===0?r.innerHTML='<option value="">Sin grupos</option>':n.groups.forEach(a=>r.innerHTML+=`<option value="${a.id}">Grupo ${a.name}</option>`)),t&&Array.from(r.options).some(a=>a.value===t)&&(r.value=t),E()}function ee(){if(typeof tui>"u")return;let t=tui.Calendar;s.calendarInstance=new t("#calendar",{defaultView:"week",useFormPopup:!1,useDetailPopup:!1,week:{taskView:!1,eventView:["time"],dayNames:["Dom","Lunes","Martes","Mi\xE9rcoles","Jueves","Viernes","S\xE1b"],workweek:!0,hourStart:8,hourEnd:15},calendars:[{id:"default",name:"Clases",backgroundColor:"#4f46e5"},{id:"pinned",name:"Fijadas",backgroundColor:"#059669"},{id:"recess",name:"Recreo",backgroundColor:"#f1f5f9",borderColor:"#94a3b8",color:"#64748b"}],template:{weekDayName(e){return`<span class="toastui-calendar-day-name-item">${e.dayName}</span>`},time(e){return e.calendarId==="recess"?'<div class="p-1 font-semibold text-slate-500 text-xs">\u2615 Recreo</div>':`
                ...
                `}}}),se(),s.calendarInstance.on("selectDateTime",function(e){s.calendarInstance.clearGridSelections();let r=typeof e.start.toDate=="function"?e.start.toDate():new Date(e.start),o=typeof e.end.toDate=="function"?e.end.toDate():new Date(e.end);F(r,o)}),s.calendarInstance.on("beforeUpdateEvent",async function(e){let{event:r,changes:o}=e,n=s.scheduledClasses.find(c=>c.id===r.id);if(!n)return;if(n.isPinned){u("Bloqueado","No puedes mover ni alterar una clase que est\xE1 fijada (Pin).","warning");return}let a=n.start,d=n.end;if(o.start&&(a=typeof o.start.toDate=="function"?o.start.toDate():new Date(o.start)),o.end&&(d=typeof o.end.toDate=="function"?o.end.toDate():new Date(o.end)),oe(new Date(a),new Date(d))){u("Error","No se puede programar una clase durante el recreo (12:00 - 12:30).","error"),E();return}o.start&&(n.start=typeof o.start.toDate=="function"?o.start.toDate():new Date(o.start)),o.end&&(n.end=typeof o.end.toDate=="function"?o.end.toDate():new Date(o.end)),n.duration=(new Date(n.end).getTime()-new Date(n.start).getTime())/(1e3*60*60),s.calendarInstance.updateEvent(r.id,r.calendarId,o),u("Sincronizando...","Guardando nueva posici\xF3n en el servidor...","info"),await s.API.updateClass(n),s.WS.sendCommand("MANUAL_EDIT",{id:n.id,action:"moved"})}),s.calendarInstance.on("clickEvent",e=>je(e.event))}function F(t=null,e=null){if(!t){let f=new Date,p=f.getDate()-f.getDay()+(f.getDay()===0?-6:1);t=new Date(f.setDate(p)),t.setHours(9,0,0,0),e=new Date(t),e.setHours(10,0,0,0)}let r=f=>f.toTimeString().slice(0,5);document.getElementById("modal-class-start").value=t.toISOString(),document.getElementById("modal-class-end").value=e.toISOString(),document.getElementById("modal-time-start").value=r(t),document.getElementById("modal-time-end").value=r(e);let o=document.getElementById("view-type-select"),n=document.getElementById("header-course-select"),a=document.getElementById("view-entity-select"),d=o?.value,c=n?.value,i=a?.value,l=document.getElementById("modal-subject"),g=document.getElementById("modal-course"),b=document.getElementById("modal-group"),m=document.getElementById("modal-teacher");if(l.innerHTML=s.subjects.map(f=>{let p=s.courses.find(h=>h.subjects.includes(f.id)),y=p?` (${p.name})`:"";return`<option value="${f.id}">${f.name}${y}</option>`}).join(""),g.innerHTML=s.courses.map(f=>`<option value="${f.id}">${f.name}</option>`).join(""),m.innerHTML=s.teachers.map(f=>`<option value="${f.id}">${f.name}</option>`).join(""),g.disabled=!1,b.disabled=!1,m.disabled=!1,d==="group"&&c)g.value=c,g.disabled=!0,k(),i&&(b.value=i,b.disabled=!0);else if(d==="teacher"&&i){m.value=i,m.disabled=!0,k();let f=s.teachers.find(p=>p.id===i);f&&f.subjects&&f.subjects.length>0&&(l.value=f.subjects[0])}else k();let x=document.getElementById("add-class-modal");x&&(x.classList.replace("hidden","flex"),x.onclick=f=>{f.target===x&&_()})}function k(){let t=document.getElementById("modal-course").value,e=document.getElementById("modal-group");e.innerHTML="";let r=s.courses.find(o=>o.id===t);r&&r.groups.length>0?r.groups.forEach(o=>{e.innerHTML+=`<option value="${o.id}">Grupo ${o.name}</option>`}):e.innerHTML='<option value="">(Sin grupos)</option>'}function _(){let t=document.getElementById("add-class-modal");t&&t.classList.replace("flex","hidden")}async function te(){let t=document.getElementById("modal-class-start").value,e=document.getElementById("modal-class-end").value,r=new Date(t),o=new Date(e),n=document.getElementById("modal-time-start").value.split(":"),a=document.getElementById("modal-time-end").value.split(":");r.setHours(parseInt(n[0]),parseInt(n[1]),0,0),o.setHours(parseInt(a[0]),parseInt(a[1]),0,0);let d=document.getElementById("modal-subject").value,c=document.getElementById("modal-group").value,i=document.getElementById("modal-teacher").value;if(!c||!i){u("Error","Faltan datos por seleccionar (Grupo o Profesor)","error");return}if(oe(r,o)){u("Error","No se puede programar una clase durante el recreo (12:00 - 12:30).","error");return}let g=(o.getTime()-r.getTime())/(1e3*60*60),b={id:"evt-"+Date.now(),start:r.toISOString(),end:o.toISOString(),duration:g,subjectId:d,groupId:c,teacherId:i,isPinned:!1};u("Guardando...","Enviando bloque a la base de datos API","info"),await s.API.saveClass(b),s.scheduledClasses.push(b),_(),E(),s.WS.sendCommand("MANUAL_EDIT",{id:b.id})}var Z=["#4f46e5","#0284c7","#059669","#d97706","#dc2626","#7c3aed","#db2777","#2563eb","#0d9488","#ca8a04","#ea580c","#e11d48","#9333ea","#16a34a"];function A(t){if(!t)return"#4f46e5";let e=0;for(let o=0;o<t.length;o++)e=t.charCodeAt(o)+((e<<5)-e);let r=Math.abs(e)%Z.length;return Z[r]}function re(){s.colorMode||(s.colorMode="teacher"),s.colorMode=s.colorMode==="teacher"?"subject":"teacher";let t=document.getElementById("btn-color-mode-text");t&&(t.textContent=s.colorMode==="teacher"?"Color: Profesor":"Color: Asignatura");let e=document.getElementById("btn-color-mode-icon");e&&(e.textContent=s.colorMode==="teacher"?"\u{1F3A8}":"\u{1F4DA}"),E()}function E(){let t=document.getElementById("view-type-select"),e=document.getElementById("view-entity-select");if(!t||!e)return;let r=t.value,o=e.value;if(s.calendarInstance&&(s.calendarInstance.clear(),se()),!o)return;let n=s.colorMode||"teacher",a=s.scheduledClasses.filter(i=>r==="teacher"?i.teacherId===o:r==="group"?i.groupId===o:!1).map(i=>{let l=s.subjects.find(h=>h.id===i.subjectId),g=s.teachers.find(h=>h.id===i.teacherId),b=s.courses.find(h=>h.groups.some(v=>v.id===i.groupId)),m=b?b.groups.find(h=>h.id===i.groupId):null,x=i.isPinned?"\u{1F4CC} ":"",f=l?`${x}${l.name}`:"Clase API",p=r==="group"?g?`Prof: ${g.name}`:"":b&&m?`${b.name} - G.${m.name}`:g?`Prof: ${g.name}`:"",y=n==="subject"?A(i.subjectId):g?g.color:"#4f46e5";return{id:i.id,calendarId:i.teacherId,title:f,body:p,start:i.start,end:i.end,isReadOnly:i.isPinned||!1,backgroundColor:y,color:"#ffffff",customStyle:{borderRadius:"6px",border:"none",padding:"2px"}}});s.calendarInstance&&s.calendarInstance.createEvents(a);let d=document.getElementById("teacher-summary-card"),c=document.getElementById("teacher-summary-content");if(r==="teacher"&&o){let i=s.teachers.find(l=>l.id===o);if(i&&d&&c){let l=s.scheduledClasses.filter(p=>p.teacherId===o),g=l.reduce((p,y)=>p+y.duration,0),b=new Map;l.forEach(p=>{let y=s.subjects.find(S=>S.id===p.subjectId),h=s.courses.find(S=>S.groups.some($e=>$e.id===p.groupId)),v=h?h.groups.find(S=>S.id===p.groupId):null,I=h?h.name:"Curso",C=v?v.name:"Grupo",D=y?y.name:"Asignatura",w=`${I}_${C}_${D}`;b.has(w)||b.set(w,{courseName:I,groupName:C,subjectName:D,hours:0}),b.get(w).hours+=p.duration});let m=i.maxHours||(s.config?Math.round(s.config.minutosMaximosProfesor/60):25),x=Array.from(b.values()),f=`
                <div class="flex flex-wrap items-center justify-between gap-4 mb-3 border-b border-gray-100 pb-2">
                    ...
                    <div class="flex items-center gap-2">
                        ...
                        <span class="text-xs font-bold px-2.5 py-1 ${g<=m?"bg-emerald-50 text-emerald-700 border border-emerald-200":"bg-amber-50 text-amber-700 border border-amber-200"} rounded-full">
                            ${g.toFixed(1)}h / ${m}h max
                        </span>
                    </div>
                </div>
            `;x.length===0?f+='<p class="text-xs text-gray-400 italic">No tiene clases asignadas en el horario actual.</p>':(f+='<div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-2.5">',x.forEach(p=>{f+=`
                        <div class="p-2.5 bg-slate-50 border border-slate-200 rounded-lg flex flex-col justify-between hover:bg-slate-100 transition-colors">
                            <span class="text-xs font-bold text-slate-800 truncate">${p.courseName} - G.${p.groupName}</span>
                            <div class="flex justify-between items-center mt-1 text-[11px]">
                                <span class="text-indigo-600 font-semibold truncate">${p.subjectName}</span>
                                <span class="font-bold text-slate-700 bg-white px-1.5 py-0.5 rounded border border-slate-200">${p.hours.toFixed(1)}h</span>
                            </div>
                        </div>
                    `}),f+="</div>"),c.innerHTML=f,d.classList.remove("hidden")}}else d&&d.classList.add("hidden")}function je(t){let e=s.scheduledClasses.find(p=>p.id===t.id);if(!e)return;let r=s.subjects.find(p=>p.id===e.subjectId),o=s.teachers.find(p=>p.id===e.teacherId);if(!r||!o)return;let n=s.courses.find(p=>p.groups.some(y=>y.id===e.groupId)),a=n?n.groups.find(p=>p.id===e.groupId):null,d=n&&a?`${n.name} - Grupo ${a.name}`:"Sin grupo",c=document.getElementById("event-detail-title");c&&(c.textContent=r.name);let l=(s.colorMode||"teacher")==="subject"?A(e.subjectId):o.color,g=document.getElementById("event-detail-header");g&&(g.style.backgroundColor=l);let b=document.getElementById("event-detail-body");b&&(b.innerHTML=`
            <p class="text-sm mb-1.5">Curso/Grupo: <b>${d}</b></p>
            <p class="text-sm">Impartida por: <b>${o.name}</b></p>
        `);let m=document.getElementById("btn-pin-event");m&&(m.innerText=e.isPinned?"Desfijar":"Fijar (Pin)",m.onclick=async()=>{e.isPinned=!e.isPinned;try{await s.API.updateClass(e)}catch(p){console.error("Error al actualizar estado del pin:",p)}s.WS.sendCommand("PIN_UPDATE",{id:e.id,state:e.isPinned}),B(),E()});let x=document.getElementById("btn-delete-event");x&&(x.onclick=async()=>{await s.API.deleteClass(e.id),s.scheduledClasses=s.scheduledClasses.filter(p=>p.id!==e.id),s.WS.sendCommand("MANUAL_EDIT",{delete:e.id}),B(),E()});let f=document.getElementById("event-detail-modal");f&&(f.classList.replace("hidden","flex"),f.onclick=p=>{p.target===f&&B()})}function B(){let t=document.getElementById("event-detail-modal");t&&t.classList.replace("flex","hidden")}function oe(t,e){let r=t.getHours(),o=t.getMinutes(),n=e.getHours(),a=e.getMinutes(),d=r*60+o,c=n*60+a,i=720,l=30;if(s.config){let b=s.config.horaInicioRecreo.split(":");i=parseInt(b[0])*60+parseInt(b[1]),l=s.config.duracionRecreo}let g=i+l;return d<g&&c>i}function se(){if(!s.calendarInstance)return;let t=new Date,e=t.getDay(),r=t.getDate()-e+(e===0?-6:1),o=new Date(t);o.setDate(r),o.setHours(0,0,0,0);let n=12,a=0,d=30;if(s.config){let c=s.config.horaInicioRecreo.split(":");n=parseInt(c[0]),a=parseInt(c[1]),d=s.config.duracionRecreo}for(let c=0;c<5;c++){let i=new Date(o);i.setDate(o.getDate()+c);let l=new Date(i);l.setHours(n,a,0,0);let g=new Date(l);g.setMinutes(l.getMinutes()+d),s.calendarInstance.createEvents([{id:`recess-${c}`,calendarId:"recess",title:"\u2615 Recreo",start:l.toISOString(),end:g.toISOString(),isReadOnly:!0,isAllDay:!1,backgroundColor:"#f1f5f9",borderColor:"#94a3b8",color:"#64748b"}])}}async function ne(){let t=document.getElementById("view-type-select"),e=document.getElementById("view-entity-select");if(!t||!e)return;if(t.value!=="group"){u("Info","Por favor, selecciona la vista de 'Grupo' para vaciar un horario espec\xEDfico.","info");return}let r=e.value;if(!r){u("Info","No hay ning\xFAn grupo seleccionado.","info");return}let o=s.courses.flatMap(a=>a.groups).find(a=>a.id===r),n=o?o.name:"este grupo";if(confirm(`\xBFEst\xE1s seguro de que deseas vaciar todas las clases programadas para el grupo "${n}"?`))try{u("Limpiando...","Eliminando clases de la base de datos...","info"),await s.API.deleteGroupSchedule(r),s.scheduledClasses=s.scheduledClasses.filter(a=>a.groupId!==r),E(),u("\xC9xito","El horario del grupo se ha vaciado.","success"),s.WS.sendCommand("MANUAL_EDIT",{action:"cleared",groupId:r})}catch(a){console.error("Error clearing schedule:",a),u("Error","No se pudo limpiar el horario.","error")}}var Pe="",$=null,V="",J=null;function ae(t,e=null){Pe=t,$=e;let r=document.getElementById("crud-modal-title"),o=document.getElementById("crud-modal-body");if(!r||!o)return;if(t==="subject"){r.textContent=e?"Editar Asignatura":"Nueva Asignatura";let d=e?s.subjects.find(i=>i.id===e):null,c=s.currentCourseId;o.innerHTML=`
            <form id="form-crud" class="space-y-4">
                ...
                <div>
                    ...
                    <div class="border border-gray-300 rounded-lg p-3 max-h-40 overflow-y-auto space-y-2 bg-gray-50">
                        ${s.teachers.map(i=>{let l=d?.teachers?.includes(i.id)||!1;return`
                                <label class="flex items-center gap-2 cursor-pointer text-sm">
                                    <input type="checkbox" name="crud-subject-teachers" value="${i.id}" ${l?"checked":""} class="rounded border-gray-300 text-indigo-600 focus:ring-indigo-500">
                                    <span>${i.name}</span>
                                </label>
                            `}).join("")}
                    </div>
            ...
            <form id="form-crud" class="space-y-4">
                ...
                <div>
                    ...
                    <div class="border border-gray-300 rounded-lg p-3 max-h-56 overflow-y-auto space-y-3 bg-gray-50">
                        ${s.courses.map(c=>{let i=s.subjects.filter(l=>c.subjects.includes(l.id));return i.length===0?"":`
                                    ...
                                    <div class="grid grid-cols-1 sm:grid-cols-2 gap-1.5 pl-1">
                                        ${i.map(l=>`
                                            <label class="flex items-center gap-2 cursor-pointer text-sm hover:bg-white p-1 rounded transition-colors">
                                                <input type="checkbox" name="crud-teacher-subjects" value="${l.id}" ${d?.subjects.includes(l.id)?"checked":""} class="rounded border-gray-300 text-indigo-600 focus:ring-indigo-500">
                                                <span class="truncate font-medium text-gray-700">${l.name} <span class="text-xs text-gray-400 font-normal">(${M(l.hours)}h)</span></span>
                                            </label>
                                        `).join("")}
                                    </div>
                                </div>
                            `}).join("")}
                        ${(()=>{let c=s.subjects.filter(i=>!s.courses.some(l=>l.subjects.includes(i.id)));return c.length===0?"":`
                                <div class="space-y-1.5">
                                    ...
                                    <div class="grid grid-cols-1 sm:grid-cols-2 gap-1.5 pl-1">
                                        ${c.map(i=>`
                                            <label class="flex items-center gap-2 cursor-pointer text-sm hover:bg-white p-1 rounded transition-colors">
                                                <input type="checkbox" name="crud-teacher-subjects" value="${i.id}" ${d?.subjects.includes(i.id)?"checked":""} class="rounded border-gray-300 text-indigo-600 focus:ring-indigo-500">
                                                <span class="truncate font-medium text-gray-700">${i.name} <span class="text-xs text-gray-400 font-normal">(${M(i.hours)}h)</span></span>
                                            </label>
                                        `).join("")}
                                    </div>
                                </div>
        ...
        `}let n=document.getElementById("crud-modal");n&&n.classList.replace("hidden","flex");let a=document.getElementById("form-crud");a&&(a.onsubmit=async d=>{if(d.preventDefault(),t==="subject"){let c=document.getElementById("crud-subject-name").value,i=parseFloat(document.getElementById("crud-subject-hours").value),l=s.currentCourseId,g=document.querySelectorAll('input[name="crud-subject-teachers"]:checked'),b=Array.from(g).map(m=>m.value);try{await s.API.saveSubject({id:$||void 0,name:c,hours:i,courseId:l,teachers:b}),u("\xC9xito","Asignatura guardada correctamente","success"),L(),O()}catch{u("Error","No se pudo guardar la asignatura","error")}}else if(t==="teacher"){let c=document.getElementById("crud-teacher-name").value,i=parseFloat(document.getElementById("crud-teacher-max-hours").value),l=document.getElementById("crud-teacher-color").value,g=document.querySelectorAll('input[name="crud-teacher-subjects"]:checked'),b=Array.from(g).map(m=>m.value);try{let m=$?s.teachers.find(f=>f.id===$):null,x=m?m.availability:[];await s.API.saveTeacher({id:$||void 0,name:c,maxHours:i,color:l,subjects:b,availability:x}),u("\xC9xito","Profesor guardado correctamente","success"),L(),H()}catch{u("Error","No se pudo guardar el profesor","error")}}else if(t==="course"){let c=document.getElementById("crud-course-name").value;try{await s.API.saveCourse({id:$||void 0,name:c}),u("\xC9xito","Curso guardado correctamente","success"),L(),j()}catch{u("Error","No se pudo guardar el curso","error")}}})}function ie(t,e=null){V=t,J=e;let r=s.courses.find(i=>i.id===t);if(!r)return;let o=e?r.groups.find(i=>i.id===e):null,n=document.getElementById("crud-modal-title");n&&(n.textContent=e?"Editar Grupo":"Nuevo Grupo");let a=document.getElementById("crud-modal-body");if(!a)return;a.innerHTML=`
    ...
    `;let d=document.getElementById("crud-modal");d&&d.classList.replace("hidden","flex");let c=document.getElementById("form-group-crud");c&&(c.onsubmit=async i=>{i.preventDefault();let l=document.getElementById("crud-group-name").value,g=document.getElementById("crud-group-tutor").value;try{let b=s.courses.find(m=>m.id===V);if(!b)return;if(J){let m=b.groups.find(x=>x.id===J);m&&(m.name=l,m.tutorId=g)}else{let m={id:"temp-"+Date.now(),name:l,tutorId:g,assignments:{}};b.groups.push(m)}await s.API.updateCourseGroup(V,b.groups),u("\xC9xito","Grupo guardado correctamente","success"),L(),j()}catch{u("Error","No se pudo guardar el grupo","error")}})}function L(){let t=document.getElementById("crud-modal");t&&t.classList.replace("flex","hidden")}function de(t){s.currentCourseId=t,window.switchTab("subjects")}async function O(){try{s.subjects=await s.API.getSubjects(),s.courses=await s.API.getCourses();let t=s.currentCourseId,e=document.getElementById("view-subjects-title");if(e){let n=s.courses.find(a=>a.id===t);e.textContent=n?`Asignaturas de ${n.name}`:"Gesti\xF3n de Asignaturas"}let r=document.getElementById("table-subjects");if(!r)return;if(r.innerHTML="",!t){r.innerHTML='<tr><td colspan="3" class="p-4 text-center text-gray-500 italic">Por favor, selecciona un curso primero.</td></tr>';return}let o=s.subjects.filter(n=>n.courseId===t);if(o.length===0){r.innerHTML='<tr><td colspan="3" class="p-4 text-center text-gray-500 italic">No hay asignaturas en este curso.</td></tr>';return}o.forEach(n=>{r.innerHTML+=`
                <tr class="hover:bg-gray-50 border-b border-gray-100 text-sm">
                    <td class="p-4 font-medium text-gray-800">${n.name}</td>
                    <td class="p-4 text-center text-gray-600">${M(n.hours)} h</td>
            ...
            `})}catch(t){console.error(t),u("Error","No se pudieron cargar las asignaturas","error")}}async function ce(t){if(confirm("\xBFEst\xE1s seguro de que deseas eliminar esta asignatura?"))try{await s.API.deleteSubject(t),u("\xC9xito","Asignatura eliminada correctamente","success"),O()}catch{u("Error","No se pudo eliminar la asignatura","error")}}async function H(){try{s.teachers=await s.API.getTeachers();let t=document.getElementById("list-teachers");if(!t)return;t.innerHTML="",s.teachers.forEach(e=>{let r=e.subjects.map(o=>{let n=s.subjects.find(d=>d.id===o);if(!n)return"";let a=s.courses.find(d=>d.subjects.includes(o));return a?`${n.name} (${a.name})`:n.name}).filter(o=>o!=="").join(", ");t.innerHTML+=`
                <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-5 flex flex-col justify-between">
                    <div>
                        ...
                        <p class="text-sm text-gray-500 mb-1">Max: <b>${M(e.maxHours)} h / semana</b></p>
            ...
            `})}catch(t){console.error(t),u("Error","No se pudieron cargar los profesores","error")}}async function le(t){if(confirm("\xBFEst\xE1s seguro de que deseas eliminar este profesor?"))try{await s.API.deleteTeacher(t),u("\xC9xito","Profesor eliminado correctamente","success"),H()}catch{u("Error","No se pudo eliminar al profesor","error")}}async function j(){try{s.courses=await s.API.getCourses(),s.teachers=await s.API.getTeachers();let t=document.getElementById("list-courses");if(!t)return;t.innerHTML="",s.courses.forEach(e=>{let r="";e.groups.length===0?r='<p class="text-xs text-gray-400 italic">No hay grupos creados en este curso.</p>':r=`
            ...
            `})}catch(t){console.error(t),u("Error","No se pudieron cargar los cursos","error")}}async function ue(t){if(confirm("\xBFEst\xE1s seguro de que deseas eliminar este curso y todos sus grupos?"))try{await s.API.deleteCourse(t),u("\xC9xito","Curso eliminado correctamente","success"),j()}catch{u("Error","No se pudo eliminar el curso","error")}}async function me(t,e){if(confirm("\xBFEst\xE1s seguro de que deseas eliminar este grupo?"))try{let r=s.courses.find(n=>n.id===t);if(!r)return;let o=r.groups.filter(n=>n.id!==e);await s.API.updateCourseGroup(t,o),u("\xC9xito","Grupo eliminado correctamente","success"),j()}catch{u("Error","No se pudo eliminar el grupo","error")}}async function pe(){let t=document.getElementById("assignments-list");if(t){t.innerHTML="";try{if(s.courses=await s.API.getCourses(),s.subjects=await s.API.getSubjects(),s.teachers=await s.API.getTeachers(),s.courses.length===0){t.innerHTML='<div class="text-center p-8 bg-gray-50 rounded-xl border border-dashed border-gray-300 text-gray-400 italic">No hay asignaciones cargadas. Cree cursos y grupos primero.</div>';return}s.courses.forEach(e=>{let r=s.subjects.filter(n=>n.courseId===e.id);if(e.groups.length===0)return;let o="";e.groups.forEach(n=>{let a="";r.length===0?a='<p class="text-xs text-gray-400 italic py-2">No hay asignaturas en este curso.</p>':r.forEach(d=>{let c=n.assignments[d.id]||"",i=s.teachers.filter(l=>l.subjects.includes(d.id));a+=`
                            <div class="flex flex-col gap-1.5 pb-3 border-b border-gray-100 last:border-b-0 last:pb-0">
                                <span class="text-sm font-semibold text-gray-700 truncate block" title="${d.name}">${d.name} (${M(d.hours)}h)</span>
                                <select onchange="updateAssignment('${e.id}', '${n.id}', '${d.id}', this.value)" class="w-full text-xs border border-gray-300 rounded-lg p-2 bg-white hover:border-slate-400 focus:border-indigo-500 outline-none transition-colors">
                                    ...
                                    ${s.teachers.map(l=>{let b=i.some(m=>m.id===l.id)?l.name:`${l.name} (No especialista)`;return`<option value="${l.id}" ${c===l.id?"selected":""}>${b}</option>`}).join("")}
                                </select>
                            </div>
                        `}),o+=`
            ...
            `})}catch(e){console.error(e),u("Error","No se pudieron cargar las asignaciones","error")}}}async function ge(t,e,r,o){try{let n=s.courses.find(d=>d.id===t);if(!n)return;let a=n.groups.find(d=>d.id===e);if(!a)return;o===""?delete a.assignments[r]:a.assignments[r]=o,await s.API.updateCourseGroup(t,n.groups),u("\xC9xito","Asignaci\xF3n actualizada","success")}catch{u("Error","No se pudo guardar la asignaci\xF3n","error")}}async function fe(t,e){try{let r=s.courses.find(a=>a.id===t);if(!r)return;let o=r.groups.find(a=>a.id===e);if(!o||!confirm(`\xBFEst\xE1s seguro de que deseas poner todas las asignaturas del grupo "${o.name}" sin asignar?`))return;o.assignments={},await s.API.updateCourseGroup(t,r.groups);let n=document.getElementById(`group-card-${t}-${e}`);n&&n.querySelectorAll("select").forEach(d=>{d.value=""}),u("\xC9xito","Todas las asignaturas del grupo han sido puestas sin asignar","success")}catch{u("Error","No se pudo limpiar las asignaciones del grupo","error")}}async function be(t){try{let e=s.courses.find(o=>o.id===t);if(!e||!confirm(`\xBFEst\xE1s seguro de que deseas poner todas las asignaturas de TODOS los grupos del curso "${e.name}" sin asignar?`))return;e.groups.forEach(o=>{o.assignments={}}),await s.API.updateCourseGroup(t,e.groups);let r=document.getElementById(`course-card-${t}`);r&&r.querySelectorAll("select").forEach(n=>{n.value=""}),u("\xC9xito","Todas las asignaturas del curso han sido puestas sin asignar","success")}catch{u("Error","No se pudo limpiar las asignaciones del curso","error")}}var K=null,P=[];function he(t){let e=s.teachers.find(d=>d.id===t);if(!e)return;K=t,P=e.availability?[...e.availability]:[];let r=document.getElementById("availability-teacher-name");r&&(r.textContent=e.name);let o=document.getElementById("availability-grid-body");if(!o)return;o.innerHTML="",[{start:"09:00",end:"09:30"},{start:"09:30",end:"10:00"},{start:"10:00",end:"10:30"},{start:"10:30",end:"11:00"},{start:"11:00",end:"11:30"},{start:"11:30",end:"12:00"},{start:"12:30",end:"13:00"},{start:"13:00",end:"13:30"},{start:"13:30",end:"14:00"}].forEach((d,c)=>{let i="";for(let l=1;l<=5;l++){let g=P.some(f=>f.dayOfWeek===l&&f.startTime===d.start&&f.endTime===d.end),b=`cell-av-${l}-${c}`,m=g?"bg-red-500 hover:bg-red-600 text-white border-red-300 font-bold":"bg-emerald-50 hover:bg-emerald-100 text-emerald-800 border-emerald-200",x=g?"NO DISPONIBLE":"DISPONIBLE";i+=`
                <td class="p-2 text-center border border-gray-200">
                    <button type="button" id="${b}" 
                        onclick="toggleAvailabilitySlot(${l}, '${d.start}', '${d.end}', '${b}')"
        ...
        `});let a=document.getElementById("availability-modal");a&&a.classList.replace("hidden","flex")}function xe(t,e,r,o){let n=document.getElementById(o);if(!n)return;let a=P.findIndex(d=>d.dayOfWeek===t&&d.startTime===e&&d.endTime===r);a>-1?(P.splice(a,1),n.className="w-full py-2 px-1 rounded text-[10px] tracking-wide transition-all bg-emerald-50 hover:bg-emerald-100 text-emerald-800 border border-emerald-200",n.textContent="DISPONIBLE"):(P.push({dayOfWeek:t,startTime:e,endTime:r}),n.className="w-full py-2 px-1 rounded text-[10px] tracking-wide transition-all bg-red-500 hover:bg-red-600 text-white border border-red-300 font-bold",n.textContent="NO DISPONIBLE")}function Q(){let t=document.getElementById("availability-modal");t&&t.classList.replace("flex","hidden")}async function ye(){if(!K)return;let t=s.teachers.find(e=>e.id===K);if(t){t.availability=P;try{await s.API.saveTeacher(t),u("\xC9xito","Disponibilidad docente guardada correctamente","success"),Q(),H()}catch{u("Error","No se pudo guardar la disponibilidad","error")}}}function ve(){let t=s.config;if(!t)return;let e=document.getElementById("settings-tiempo-minimo"),r=document.getElementById("settings-tiempo-maximo"),o=document.getElementById("settings-max-minutos-profesor"),n=document.getElementById("settings-priorizar-tutor"),a=document.getElementById("settings-priorizar-tutor-puntos"),d=document.getElementById("settings-bloques-60-puntos"),c=document.getElementById("settings-minimizar-asignaturas"),i=document.getElementById("settings-minimizar-asignaturas-puntos"),l=document.getElementById("settings-limite-tiempo"),g=document.getElementById("settings-tiempo-estancamiento"),b=document.getElementById("settings-hora-inicio"),m=document.getElementById("settings-hora-fin"),x=document.getElementById("settings-recreo-inicio"),f=document.getElementById("settings-recreo-duracion"),p=document.getElementById("settings-respetar-especialidad"),y=document.getElementById("settings-respetar-limite-horas"),h=document.getElementById("settings-respetar-disponibilidad");if(e&&(e.value=t.tiempoMinimo.toString()),r&&(r.value=t.tiempoMaximo.toString()),o&&(o.value=t.minutosMaximosProfesor.toString()),n){n.checked=t.priorizarTutor;let v=document.getElementById("settings-tutor-points-container");v&&(v.style.display=t.priorizarTutor?"flex":"none"),n.onchange=()=>{v&&(v.style.display=n.checked?"flex":"none")}}if(a&&(a.value=t.priorizarTutorPuntos.toString()),d&&(d.value=t.fomentarBloques60Puntos.toString()),c){c.checked=t.minimizarAsignaturasDistintas??!0;let v=document.getElementById("settings-minimizar-asignaturas-points-container");v&&(v.style.display=c.checked?"flex":"none"),c.onchange=()=>{v&&(v.style.display=c.checked?"flex":"none")}}i&&(i.value=(t.minimizarAsignaturasPuntos??50).toString()),l&&(l.value=(t.limiteTiempoSegundos??18e3).toString()),g&&(g.value=(t.tiempoEstancamientoSegundos??60).toString()),b&&(b.value=t.horaInicioClases),m&&(m.value=t.horaFinClases),x&&(x.value=t.horaInicioRecreo),f&&(f.value=t.duracionRecreo.toString()),p&&(p.checked=t.respetarEspecialidad),y&&(y.checked=t.respetarLimiteHoras),h&&(h.checked=t.respetarDisponibilidad)}async function Ee(){let t=document.getElementById("settings-tiempo-minimo"),e=document.getElementById("settings-tiempo-maximo"),r=document.getElementById("settings-max-minutos-profesor"),o=document.getElementById("settings-priorizar-tutor"),n=document.getElementById("settings-priorizar-tutor-puntos"),a=document.getElementById("settings-bloques-60-puntos"),d=document.getElementById("settings-minimizar-asignaturas"),c=document.getElementById("settings-minimizar-asignaturas-puntos"),i=document.getElementById("settings-limite-tiempo"),l=document.getElementById("settings-tiempo-estancamiento"),g=document.getElementById("settings-hora-inicio"),b=document.getElementById("settings-hora-fin"),m=document.getElementById("settings-recreo-inicio"),x=document.getElementById("settings-recreo-duracion"),f=document.getElementById("settings-respetar-especialidad"),p=document.getElementById("settings-respetar-limite-horas"),y=document.getElementById("settings-respetar-disponibilidad"),h={priorizarTutor:o?o.checked:!1,tiempoMinimo:t?parseInt(t.value):30,tiempoMaximo:e?parseInt(e.value):60,minutosMaximosProfesor:r?parseInt(r.value):1500,priorizarTutorPuntos:n?parseInt(n.value):100,fomentarBloques60Puntos:a?parseInt(a.value):10,minimizarAsignaturasDistintas:d?d.checked:!0,minimizarAsignaturasPuntos:c?parseInt(c.value):50,limiteTiempoSegundos:i?parseFloat(i.value):18e3,tiempoEstancamientoSegundos:l?parseFloat(l.value):60,horaInicioClases:g?g.value:"09:00",horaFinClases:b?b.value:"14:00",horaInicioRecreo:m?m.value:"12:00",duracionRecreo:x?parseInt(x.value):30,respetarEspecialidad:f?f.checked:!0,respetarLimiteHoras:p?p.checked:!0,respetarDisponibilidad:y?y.checked:!0};try{s.config=await s.API.saveConfig(h),u("\xC9xito","Configuraci\xF3n de reglas guardada correctamente","success")}catch{u("Error","No se pudo guardar la configuraci\xF3n","error")}}var z={ok:'<svg class="w-5 h-5 text-emerald-500 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 13l4 4L19 7"/></svg>',warning:'<svg class="w-5 h-5 text-amber-500 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 9v2m0 4h.01m-6.938 4h13.856c1.54 0 2.502-1.667 1.732-3L13.732 4c-.77-1.333-2.694-1.333-3.464 0L3.34 16c-.77 1.333.192 3 1.732 3z"/></svg>',error:'<svg class="w-5 h-5 text-red-500 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M10 14l2-2m0 0l2-2m-2 2l-2-2m2 2l2 2m7-2a9 9 0 11-18 0 9 9 0 0118 0z"/></svg>'},Ie={ok:{bg:"bg-emerald-50",border:"border-emerald-200",text:"text-emerald-700"},warning:{bg:"bg-amber-50",border:"border-amber-200",text:"text-amber-700"},error:{bg:"bg-red-50",border:"border-red-200",text:"text-red-700"}};function ke(t){let e=Ie[t.status]||Ie.ok,r=t.details.length>0?`<ul class="mt-2 ml-6 space-y-0.5 text-xs ${e.text} opacity-80">${t.details.map(o=>`<li class="list-disc">${o}</li>`).join("")}</ul>`:"";return`
    ...
    `,r.innerHTML="";try{let o=await s.API.getPrevalidation(),n=o.checks.filter(i=>i.status==="error").length,a=o.checks.filter(i=>i.status==="warning").length,d=o.checks.filter(i=>i.status==="ok").length;o.viable?r.innerHTML=`
            ...
            `;let c=[...o.checks].sort((i,l)=>{let g={error:0,warning:1,ok:2};return(g[i.status]??2)-(g[l.status]??2)});e.innerHTML=c.map(ke).join("")}catch(o){e.innerHTML=`
            <div class="text-center py-8 text-red-500">
                <p class="font-bold">Error al ejecutar la pre-validaci\xF3n</p>
                <p class="text-sm text-gray-500 mt-1">${o}</p>
            </div>
        `}}}function Ce(){let t=document.getElementById("prevalidation-modal");t&&(t.classList.add("hidden"),t.classList.remove("flex"))}function Te(){if(!s.courses||s.courses.length===0){u("Info","No hay cursos ni grupos registrados para imprimir.","info");return}let t=document.getElementById("print-area");t||(t=document.createElement("div"),t.id="print-area",document.body.appendChild(t));let e=9,r=14,o=30;if(s.config){let l=s.config.horaInicioClases.split(":"),g=s.config.horaFinClases.split(":");e=parseInt(l[0]),r=parseInt(g[0]),o=s.config.tiempoMinimo||30}let n=[],a=e*60,d=r*60;for(;a<d;){let l=a+o,g=Math.floor(a/60).toString().padStart(2,"0"),b=(a%60).toString().padStart(2,"0"),m=Math.floor(l/60).toString().padStart(2,"0"),x=(l%60).toString().padStart(2,"0");n.push({startStr:`${g}:${b}`,endStr:`${m}:${x}`,startMin:a,endMin:l}),a=l}let c=[{id:1,name:"Lunes"},{id:2,name:"Martes"},{id:3,name:"Mi\xE9rcoles"},{id:4,name:"Jueves"},{id:5,name:"Viernes"}],i="";s.courses.forEach(l=>{l.groups.forEach(g=>{let b=s.scheduledClasses.filter(m=>m.groupId===g.id);i+=`
                <div class="print-page">
                    <div class="flex justify-between items-center mb-2 border-b-2 border-indigo-600 pb-1">
                        <div>
                            <h1 class="text-xl font-bold text-gray-900 leading-tight">${l.name} - Grupo ${g.name}</h1>
                    ...
                    <table class="w-full border-collapse border border-gray-300 text-xs table-fixed">
                        ...
                        <tbody>
            `,n.forEach(m=>{let x=!1;if(s.config){let f=s.config.horaInicioRecreo.split(":"),p=parseInt(f[0])*60+parseInt(f[1]),y=p+s.config.duracionRecreo;m.startMin>=p&&m.startMin<y&&(x=!0)}if(x){i+=`
                    ...
                    `;return}i+="<tr>",i+=`<td class="p-1 border border-gray-300 text-center font-mono text-[9px] font-medium bg-gray-50">${m.startStr} - ${m.endStr}</td>`,c.forEach(f=>{let p=b.find(y=>{let h=new Date(y.start);return h.getDay()!==f.id?!1:h.getHours()*60+h.getMinutes()===m.startMin});if(p){let y=s.subjects.find(C=>C.id===p.subjectId),h=s.teachers.find(C=>C.id===p.teacherId),v=A(p.subjectId),I=p.isPinned?"\u{1F4CC} ":"";i+=`
                            <td class="p-1 border border-gray-300 align-top text-white font-medium shadow-inner" style="background-color: ${v} !important; color: white !important; -webkit-print-color-adjust: exact !important; print-color-adjust: exact !important;">
                                ...
                                ${h?`<div class="text-[9px] opacity-95 truncate leading-tight font-normal">Prof: ${h.name}</div>`:""}
                            </td>
                        `}else i+='<td class="p-1 border border-gray-300 text-center text-gray-300 bg-white text-[9px]">--</td>'}),i+="</tr>"}),i+=`
                        </tbody>
                    </table>
                </div>
            `})}),s.teachers.forEach(l=>{let g=s.scheduledClasses.filter(m=>m.teacherId===l.id),b=g.reduce((m,x)=>m+x.duration,0);i+=`
            <div class="print-page">
                <div class="flex justify-between items-center mb-2 border-b-2 border-indigo-600 pb-1">
                    <div>
                        <h1 class="text-xl font-bold text-gray-900 leading-tight">Horario Personal Docente: ${l.name}</h1>
        ...
        `,n.forEach(m=>{let x=!1;if(s.config){let f=s.config.horaInicioRecreo.split(":"),p=parseInt(f[0])*60+parseInt(f[1]),y=p+s.config.duracionRecreo;m.startMin>=p&&m.startMin<y&&(x=!0)}if(x){i+=`
                ...
                `;return}i+="<tr>",i+=`<td class="p-1 border border-gray-300 text-center font-mono text-[9px] font-medium bg-gray-50">${m.startStr} - ${m.endStr}</td>`,c.forEach(f=>{let p=g.find(y=>{let h=new Date(y.start);return h.getDay()!==f.id?!1:h.getHours()*60+h.getMinutes()===m.startMin});if(p){let y=s.subjects.find(w=>w.id===p.subjectId),h=s.courses.find(w=>w.groups.some(S=>S.id===p.groupId)),v=h?h.groups.find(w=>w.id===p.groupId):null,I=h&&v?`${h.name} G.${v.name}`:"",C=A(p.subjectId),D=p.isPinned?"\u{1F4CC} ":"";i+=`
    ...
    `;try{let o=await fetch("/api/v1/system/update/install",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({downloadUrl:t.browser_download_url,fileName:t.name})});if(o.ok){let n=document.getElementById("update-status-text");n&&(n.innerText="\xA1Descarga completa! Iniciando instalador..."),u("Actualizaci\xF3n","La aplicaci\xF3n se est\xE1 reiniciando con la nueva versi\xF3n.","success")}else throw new Error(`Servidor devolvi\xF3 status ${o.status}`)}catch(o){console.error("Error al ejecutar actualizaci\xF3n de un clic:",o),u("Error de actualizaci\xF3n","No se pudo actualizar autom\xE1ticamente. Abriendo descarga directa.","warning"),r.innerHTML=`
            <div class="space-y-2">
